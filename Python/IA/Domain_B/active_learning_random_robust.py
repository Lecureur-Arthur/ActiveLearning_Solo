...
# ==========================================
# 4. BOUCLE DES ROUNDS (Répétition)
# ==========================================
for round_idx in range(N_ROUNDS):
    print(f"\n=== ROUND {round_idx + 1}/{N_ROUNDS} ===")
    
    # Création du dossier spécifique pour ce round
    round_dir = results_dir / f"Round_{round_idx + 1}"
...
# ==========================================
# 5. CALCUL STATISTIQUE & GRAPHIQUE
# ==========================================
